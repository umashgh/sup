"""
Quick tier calculator for Termination / Severance scenario.
"""
...
class QuickTerminationCalculator(BaseCalculator):
    def calculate(self) -> Dict:
        """
        Perform quick Termination runway calculation.
        """
        # Get user inputs
        ...
        severance_lumpsum = float(self.get_field_value('scenario.severance_lumpsum', 0))
        ...
        # Available cash includes severance, minus emergency fund and one-time hits
        available_cash = max(0, total_assets + severance_lumpsum - emergency_fund_lock - one_time_expenses)
        ...
        return {
            ...
            'severance_lumpsum': round(severance_lumpsum, 2),
